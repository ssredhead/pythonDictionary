...
#analyze runtime by counting the number of iterations the while loop will perform based on input size
...
runtime = "log N" #because N is divided by 2 each iteration
