...
queue_runtime = "1" #the first item is always constant time to dequeue
...
stack_runtime = "N" #the first item is always the last on the stack, so you must traverse the stack to remove it. Linear time
